...
<p align="center"><strong>Figure:</strong>Top Left) RGB Image of Degraded Area, (Top Right) RGB Image of Conserved Area , (Bottom Left) SAM Classified Conserved Area , (Bottom Right)  SAM Classified Degraded Area<br>Classes: Green = PV, Red = NPV, Brown = Bare Soil, White = Shadow, and Black = Unclassified.</p>
